 ...
 * 
 */
@WebServiceClient(name = "saludosPortService", targetNamespace = "t4is.uv.mx/saludos", wsdlLocation = "https://produsctoss-production.up.railway.app/ws/productos.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://produsctoss-production.up.railway.app/ws/productos.wsdl");
