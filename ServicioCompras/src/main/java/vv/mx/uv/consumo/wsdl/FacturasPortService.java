 ...
 * 
 */
@WebServiceClient(name = "facturasPortService", targetNamespace = "https://t4is.uv.mx/facturas", wsdlLocation = "https://facturas-production-a07e.up.railway.app/ws/facturas.wsdl")
    ...
    extends Service
{
    ...
    private final static QName FACTURASPORTSERVICE_QNAME = new QName("https://t4is.uv.mx/facturas", "facturasPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://facturas-production-a07e.up.railway.app/ws/facturas.wsdl");
    ...
    public FacturasPort getFacturasPortSoap11() {
        return super.getPort(new QName("https://t4is.uv.mx/facturas", "facturasPortSoap11"), FacturasPort.class);
    }
    ...
    public FacturasPort getFacturasPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("https://t4is.uv.mx/facturas", "facturasPortSoap11"), FacturasPort.class, features);
    }
