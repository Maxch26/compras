...
@XmlRootElement(name = "HistorialFacturasResponse")
public class HistorialFacturasResponse {

    @XmlElement(required = true)
    protected List<HistorialFacturasResponse.Factura> factura;
     ...
     * {@link HistorialFacturasResponse.Factura }
     * 
     * 
     */
    public List<HistorialFacturasResponse.Factura> getFactura() {
        if (factura == null) {
            factura = new ArrayList<HistorialFacturasResponse.Factura>();
        }
        return this.factura;
    }
